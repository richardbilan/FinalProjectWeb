...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'My Webpage'); ?></title>
...
<body>
    ...
    <nav class="navbar">
        <div class="navdiv">
            <div class="logo"><a href="<?php echo e(url('/')); ?>">ZarWho</a></div>
                <ul>
                    <li><a href="<?php echo e(route('lab1')); ?>">Lab1</a></li>
                    <li><a href="<?php echo e(route('lab2')); ?>">Lab2</a></li>
                    <li><a href="<?php echo e(route('lab3')); ?>">Lab3</a></li>
                    <li><a href="<?php echo e(route('lab4')); ?>">Lab4</a></li>
                    <li><a href="<?php echo e(route('about')); ?>">Socials</a></li>
                    <li>
                    <form action="<?php echo e(route('ageverification')); ?>">
...
<?php /**PATH C:\Users\Richard Bilan\Documents\GitHub\WebDevFinalProj\FinalProject\resources\views/components/layout.blade.php ENDPATH**/ ?>